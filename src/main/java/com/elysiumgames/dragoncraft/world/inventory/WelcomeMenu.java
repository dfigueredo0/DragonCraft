...
public class WelcomeMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
    ...
    protected WelcomeMenu(int pContainerId, Inventory inventory, FriendlyByteBuf extraData) {
        super(ModMenuTypes.WELCOME_MENU.get(), pContainerId);
