package com.elysiumgames.dragoncraft.world.level.levelgen.portal;

import com.elysiumgames.dragoncraft.world.level.block.ModBlocks;
import com.elysiumgames.dragoncraft.world.level.block.custom.NamekPortalBlock;
...
public class NamekTeleporter implements ITeleporter {
    public static BlockPos thisPos = BlockPos.ZERO;
    public static boolean insideDimension = true;

    public NamekTeleporter(BlockPos pos, boolean insideDim) {
        thisPos = pos;
    ...
    public Entity placeEntity(Entity entity, ServerLevel currentWorld, ServerLevel destWorld, float yaw, Function<Boolean, Entity> repositionEntity) {
        ...
        if (insideDimension) {
            ...
            for (BlockPos checkPos : BlockPos.betweenClosed(destinationPos.below(10).west(10),
                ...
                if (destWorld.getBlockState(checkPos).getBlock() instanceof NamekPortalBlock) {
                    doSetBlock = false;
                    break;
                }
            }
            ...
            if (doSetBlock) {
                destWorld.setBlock(destinationPos, ModBlocks.NAMEK_PORTAL.get().defaultBlockState(), 3);
            }
        }
